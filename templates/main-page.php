...
<div class="wrap">
    ...
    <form method="post" action="options.php">
        <table class="form-table">
            <tr valign="top">
                <th scope="row"><label for="wps_client_id">File Name (without ".json")</label></th>
                <td>
                    <input type="text" id="wps_client_id" name="wps_client_id" class="regular-text" value="<?php echo esc_attr(get_option('wps_sender_filename')); ?>" />
